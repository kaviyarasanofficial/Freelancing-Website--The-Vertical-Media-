...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($thumbnailTempName, $thumbnailPath)) {
        ...
        $sql = "INSERT INTO `newproj` (`Name`, `Description`, `thumbnail_url`, `skills`, `payment_method`, `catagories`, `budget`,`date`,`email`)
        VALUES ('$Name', '$Description', '$thumbnailPath', '$skills', '$paymentMethod', '$catagories', '$budget','$date','$email')";
