...
include "Pages/php/projfunc.php";
      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <ul class="navbar-nav ">
              <li>
                <a class="nav-link px-3 sidebar-link active" data-bs-toggle="collapse" href="#projects">
                ...
                <div class="collapse" id="projects">
                  <ul class="navbar-nav ps-3 active">
                    <li>
        ...
        <div class="row">
          <div class="col-md-3 mb-3">
            <div class="card bg-primary text-white h-100">
              <div class="card-body py-5">New Projects</div>
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-warning text-dark h-100">
              <div class="card-body py-5">Projects Manage</div>
              <div class="card-footer d-flex">
                View Details
                <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
