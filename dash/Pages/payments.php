                ...
                <tbody>
                    <?php foreach ($payments as $pay): ?>
                        <tr>
                            ...
                            <td><a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" href="php/delete.php?razorpay_payment_id=<?= urlencode($pay['razorpay_payment_id']) ?>" onclick="return confirm('Are you sure you want to delete this project?')">Delete</a>
                            </td>
