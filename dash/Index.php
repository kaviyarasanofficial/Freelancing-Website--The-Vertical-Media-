        ...
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <ul class="navbar-nav">
                  ...
                  <ul class="navbar-nav ps-3">
                    <li>
                      <a href="../postproject.php" class="nav-link px-3">
                        <span class="me-2"><i class="bi bi-speedometer2"></i></span>
                        <span onclick="window.location.href='Pages/projectsmanage.php';">New Projects</span>
                      </a>
                    </li>
                    <li>
              ...
              <li>
                <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#freelancers">
                  <span class="me-2"><i class="bi bi-layout-split"></i></span>
        ...
        <div class="row">
          <div class="col-md-3 mb-3">
            <div class="card bg-primary text-white h-100">
              <div class="card-body py-5">Users <br><h1> <?php
                echo "<p>" . $userCount . "</p>";
               ?>
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-warning text-dark h-100">
              <div class="card-body py-5">Projects <h1><?php
...
?></div></h1>
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-success text-white h-100">
              <div class="card-body py-5">Catagorie Counts <h1><?php
// Your PHP code to get the user count from MySQL (as shown in the previous response)

// Output the user count inside an HTML paragraph tag
echo "<p>" . $catagorie_name . "</p>";
?></div></h1>
              <div class="card-footer d-flex">
                View Details
                <span class="ms-auto">
